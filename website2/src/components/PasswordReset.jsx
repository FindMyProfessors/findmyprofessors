            ...
            <MDBRow className='g-0'>
              ...
              <MDBCol md='12'>
                <MDBCardBody className='d-flex flex-column'>
                  ...
                  <h5 className="fw-normal my-4 pb-3" style={{letterSpacing: '1px', color: 'white'}}>If you entered a valid email address, a recovery code will be sent to you. <Link to="/Login">Login</Link></h5>
