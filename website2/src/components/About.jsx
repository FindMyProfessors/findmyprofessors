...
const About = () => {
    ...
    <>
        ...
        <MDBContainer style={containerStyle}>
            <MDBCard style={{ width: '100%', margin: '0 auto', backgroundColor: '#282828', boxShadow: '3px 3px 12px rgba(0, 0, 0, 0.75)'  }}>
                <MDBRow className='g-0'>

                    <MDBCol md='6'>
                        <MDBCard style={{ width: '90%', margin: '0 auto', marginTop: '20px', marginBottom: '20px', backgroundColor: '#3f3f3f', boxShadow: '3px 3px 12px rgba(0, 0, 0, 0.75)'  }}>
                            <MDBCardHeader style={{ fontSize: '2rem', color:'white' }}><b>Find my Professors</b></MDBCardHeader>
                            <MDBCardBody style={{ padding: '15px' }}>
                                
                                <MDBCardTitle style={{ color: 'white' }}>Why choose Find my Professors?</MDBCardTitle>
                                <MDBCardText style={{ color: 'white' }}>
                                    ...
                                    <MDBListGroup light numbered style={{ minWidth: '22rem', backgroundColor: '#3f3f3f'  }}>

                                        <MDBListGroupItem className='d-flex justify-content-between align-items-start' style={{ backgroundColor: '#3f3f3f', color:'white' }}>
                                ...
                                <MDBCol md="4" offsetMd="0">
                                    <MDBCard className='h-100' style={{backgroundColor: '#3f3f3f', boxShadow: '3px 3px 12px rgba(0, 0, 0, 0.75)'  }}>
                                        <MDBCardImage src='https://i.imgur.com/j4QoUgR.png' position='top' alt='...' />
                                            <MDBCardBody >
                                                <MDBCardTitle style={{ color: 'white' }}>Overall Quality</MDBCardTitle>
                                                    <MDBCardText style={{ color: 'white' }}>
                                ...
                                <MDBCol md="4">
                                    <MDBCard className='h-100' style={{backgroundColor: '#3f3f3f', boxShadow: '3px 3px 12px rgba(0, 0, 0, 0.75)'  }}>
                                        <MDBCardImage src='https://i.imgur.com/YYboB11.png' position='top' alt='...' />
                                            <MDBCardBody>
                                                <MDBCardTitle style={{ color: 'white' }}>Average Grade</MDBCardTitle>
                                                    <MDBCardText style={{ color: 'white' }}>
                                ...
                                <MDBCol md="4">
                                    <MDBCard className='h-100' style={{backgroundColor: '#3f3f3f', boxShadow: '3px 3px 12px rgba(0, 0, 0, 0.75)'  }}>
                                        <MDBCardImage src='https://i.imgur.com/2sNQteW.png' position='top' alt='...' />
                                            <MDBCardBody>
                                                <MDBCardTitle style={{ color: 'white' }}>Difficulty</MDBCardTitle>
                                                    <MDBCardText style={{ color: 'white' }}>
                                ...
                                <MDBCol md="4" style={sectionStyle}>
                                    <MDBCard className='h-100' style={{backgroundColor: '#3f3f3f', boxShadow: '3px 3px 12px rgba(0, 0, 0, 0.75)'  }}>
                                        <MDBCardImage src='https://i.imgur.com/TOYrhFO.png' position='top' alt='...' />
                                            <MDBCardBody>
                                                <MDBCardTitle style={{ color: 'white' }}>Would take again</MDBCardTitle>
                                                    <MDBCardText style={{ color: 'white' }}>
                                ...
                                <MDBCol md="4" style={sectionStyle}>
                                    <MDBCard className='h-100' style={{backgroundColor: '#3f3f3f', boxShadow: '3px 3px 12px rgba(0, 0, 0, 0.75)'  }}>
                                        <MDBCardImage src='https://i.imgur.com/lMi72st.png' position='top' alt='...' />
                                            <MDBCardBody>
                                                <MDBCardTitle style={{ color: 'white' }}>Attendance</MDBCardTitle>
                                                    <MDBCardText style={{ color: 'white' }}>
                                ...
                                <MDBCol md="4" style={sectionStyle}>
                                    <MDBCard className='h-100' style={{backgroundColor: '#3f3f3f', boxShadow: '3px 3px 12px rgba(0, 0, 0, 0.75)'  }}>
                                        <MDBCardImage src='https://i.imgur.com/ju9c2zL.png' position='top' alt='...' />
                                            <MDBCardBody>
                                                <MDBCardTitle style={{ color: 'white' }}>Top tags</MDBCardTitle>
                                                    <MDBCardText style={{ color: 'white' }}>
