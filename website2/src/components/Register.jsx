            ...
            <MDBCol md='12'>
              <MDBCardBody className='d-flex flex-column'>
                ...
                <form onSubmit={handleSubmit}>
                  <MDBInput wrapperClass='mb-4' label='Username' id='formControlLg' size="lg" name="username" onChange={handleChange} value={formData.username} />
                  <MDBInput wrapperClass='mb-4' label='Email address' id='formControlLg' type='email' size="lg" name="email" onChange={handleChange} value={formData.email} />
                  ...
                  <MDBInput wrapperClass='mb-4' label='Confirm Password' id='formControlLg' type='password' size="lg" name="confirmPassword" onChange={handleChange} value={formData.confirmPassword} />
